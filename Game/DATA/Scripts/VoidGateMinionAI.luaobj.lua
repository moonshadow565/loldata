...
function TimerFindEnemies()
  ...
  if L0_0 == L1_1 then
    ...
    L1_1 = L1_1(UnitTagFlags.Minion + UnitTagFlags.Structure, UnitTagFlags.Special_Void)
    if L1_1 == nil then
...
function FindTargetOrMove()
  ...
  L1_3 = L1_3(UnitTagFlags.Minion + UnitTagFlags.Structure, UnitTagFlags.Special_Void)
  if L1_3 then
