...
OnBuffActivateBuildingBlocks = {
  ...
  },
  {
    ...
    Params = {
      BindObjectVar = "Owner",
      EffectName = "JarvanDemacianStandard_buf_green.troy",
      EffectNameForOtherTeam = "JarvanDemacianStandard_buf_red.troy",
      Flags = 0,
...
OnBuffDeactivateBuildingBlocks = {
  ...
  },
  {
    ...
    Params = {
      TargetVar = "Owner",
      AttackerVar = "Owner",
      BuffName = "NoRenderExpirationBuff",
        ...
        SubBlocks = {
          {
            ...
            Params = {
              TargetVar = "Unit",
              AttackerVar = "Attacker",
              BuffName = "JarvanIVDemacianStandardBuff",
...
SelfExecuteBuildingBlocks = {
  ...
  },
  {
    ...
    Params = {
      ...
      EffectName = "JarvanDemacianStandard_mis.troy",
      Flags = 0,
      EffectIDVar = "a",
      BoneName = "R_Hand",
  ...
  },
  {
    ...
    Params = {
      TargetVar = "Other3",
      AttackerVar = "Attacker",
      BuffName = "JarvanIVDemacianStandardDelay",
      BuffAddType = BUFF_REPLACE_EXISTING,
      StacksExclusive = true,
      BuffType = BUFF_Internal,
      MaxStack = 1,
