...
OnBuffActivateBuildingBlocks = {
  ...
  },
  {
    ...
    Params = {
      BindObjectVar = "Owner",
      EffectName = "KogMawDeathProc.troy",
      Flags = 0,
  ...
  },
  {
    ...
    Params = {
      BindObjectVar = "Owner",
      EffectName = "KogMawDeathBackBeam.troy",
      Flags = 0,
      EffectIDVar = "Particle",
      BoneName = "C_Chest",
      TargetObjectVar = "Target",
...
OnBuffDeactivateBuildingBlocks = {
  ...
  },
  {
    ...
    Params = {
      BindObjectVar = "Owner",
      EffectName = "KogMawDeath_nova.troy",
      Flags = 0,
      EffectIDVar = "e",
      TargetObjectVar = "Owner",
      SpecificUnitOnlyVar = "Owner",
  ...
  },
  {
    ...
    Params = {
      BindObjectVar = "Owner",
      EffectName = "KogMawDead_idle.troy",
      Flags = 0,
      EffectIDVar = "e",
      BoneName = "intestines_1",
      TargetObjectVar = "Owner",
      SpecificUnitOnlyVar = "Owner",
      SpecificTeamOnly = TEAM_UNKNOWN,
      UseSpecificUnit = false,
