...
OnBuffActivateBuildingBlocks = {
  ...
  },
  {
    ...
    Params = {
      ...
      EffectName = "leBlanc_shackle_chain_beam_ult.troy",
      Flags = 0,
  ...
  },
  {
    ...
    Params = {
      BindObjectVar = "Attacker",
      EffectName = "leBlanc_shackle_self_idle_ult.troy",
      Flags = 0,
  ...
  },
  {
    ...
    Params = {
      BindObjectVar = "Owner",
      EffectName = "leBlanc_shackle_target_idle_ult.troy",
      Flags = 0,
      EffectIDVar = "SoulShackleIdleM",
      EffectIDVarTable = "InstanceVars",
      BoneName = "spine",
      TargetObjectVar = "Owner",
      SpecificUnitOnlyVar = "Owner",
