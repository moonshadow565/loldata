    ...
    SubBlocks = {
      {
        ...
        Params = {
          BindObjectVar = "Owner",
          EffectName = "exile_W_cast_ult_01.troy",
          Flags = 0,
          EffectIDVar = "Temp",
      ...
      },
      {
        ...
        Params = {
          BindObjectVar = "Owner",
          EffectName = "exile_W_cast_02.troy",
          Flags = 0,
          EffectIDVar = "Temp",
          EffectIDVarTable = "InstanceVars",
          TargetObjectVar = "Owner",
      ...
      },
      {
        ...
        Params = {
          BindObjectVar = "Owner",
          EffectName = "exile_W_weapon_cas.troy",
          Flags = 0,
          EffectIDVar = "Temp",
          EffectIDVarTable = "InstanceVars",
      ...
      },
      {
        ...
        Params = {
          BindObjectVar = "Owner",
          EffectName = "exile_W_cast_ult_02.troy",
          Flags = 0,
          EffectIDVar = "Temp",
          EffectIDVarTable = "InstanceVars",
          TargetObjectVar = "Owner",
    ...
    SubBlocks = {
      {
        ...
        Params = {
          BindObjectVar = "Owner",
          EffectName = "exile_W_cast_01.troy",
          Flags = 0,
          EffectIDVar = "Temp",
          EffectIDVarTable = "InstanceVars",
          TargetObjectVar = "Owner",
