    ...
    SubBlocks = {
      {
        ...
        Params = {
          TargetVar = "Unit",
          AttackerVar = "Attacker",
          BuffName = "VeigarEventHorizonMarker",
    ...
    SubBlocks = {
      {
        ...
        Params = {
          ...
          EffectNameForOtherTeam = "permission_desecrate_red_cas_leprechaun.troy",
          Flags = 0,
    ...
    SubBlocks = {
      {
        ...
        Params = {
          ...
          EffectNameForOtherTeam = "permission_desecrate_red_cas.troy",
          Flags = 0,
          EffectIDVar = "Particle2",
          EffectIDVarTable = "InstanceVars",
          EffectID2Var = "Particle",
        ...
        SubBlocks = {
          {
            ...
            Params = {
              OwnerVar = "Unit",
              CasterVar = "Attacker",
              BuffName = "VeigarEventHorizonPrevent"
            },
            SubBlocks = {
              {
                Function = BBMath,
