...
OrderNames = {
  ...
  CasterMinionName = "Blue_Minion_Wizard",
  CannonMinionName = "Blue_Minion_MechCannon",
  SuperMinionName = "Blue_Minion_MechMelee"
}
ChaosNames = {
  MeleeMinionName = "Red_Minion_Basic",
  CasterMinionName = "Red_Minion_Wizard",
  CannonMinionName = "Red_Minion_MechCannon",
...
function GetMinionSpawnInfo(_ARG_0_, _ARG_1_, _ARG_2_, _ARG_3_, _ARG_4_)
  ...
  if _ARG_1_ % CANNON_MINION_SPAWN_FREQUENCY == 0 then
    TableForBarrack.NumOfCannonMinionsPerWave = TableForBarrack.NumOfCannonMinionsPerWave + 1
  ...
  if _ARG_3_ == TEAM_ORDER then
    ...
    ChaosBarracksBonuses[_ARG_0_ + 1].CannonMinionName = OrderNames.CannonMinionName
    ...
    ChaosBarracksBonuses[_ARG_0_ + 1].CannonMinionName = ChaosNames.CannonMinionName
  ...
  ReturnTable = {
    ...
    CannonMinionName = ChaosBarracksBonuses[_ARG_0_ + 1].CannonMinionName,
    ...
    CannonMinionArmor = ChaosBarracksBonuses[_ARG_0_ + 1].CannonMinionArmor,
    CannonMinionMagicResistance = ChaosBarracksBonuses[_ARG_0_ + 1].CannonMinionMagicResistance,
    CannonHPBonus = ChaosBarracksBonuses[_ARG_0_ + 1].CannonHPBonus,
    CannonDamageBonus = ChaosBarracksBonuses[_ARG_0_ + 1].CannonDamageBonus,
    CannonExpGiven = ChaosBarracksBonuses[_ARG_0_ + 1].CannonExpGiven,
    CannonGoldGiven = ChaosBarracksBonuses[_ARG_0_ + 1].CannonGoldGiven,
